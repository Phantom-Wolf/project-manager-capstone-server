...
describe("Events Endpoints", function () {
	...
	describe("GET all parentTasks", () => {
		context(`Given no parentTasks`, () => {
		...
		context("Given there are parentTasks in the database", () => {
			...
			it("responds with 200 and all of the parentTasks", () => {
				return supertest(app)
					.post("/api/parentTask/getAll")
					.set(
						"Authorization",
